...
const toolTitles: Record<string, string> = {
	...
	"agent-templateCustomizerAgent": "Adjusting your template design",
	"agent-radarAgent": "Checking Job Radar",
	resumeAgent: "Working on your resume",
	profileEditAgent: "Learning about you",
	templateCustomizerAgent: "Adjusting your template design",
	radarAgent: "Checking Job Radar",
	"resume-agent": "Working on your resume",
	"profile-edit-agent": "Learning about you",
	"template-customizer-agent": "Adjusting your template design",
	"job-radar-agent": "Checking Job Radar",
	...
	update_resume_document: "Editing your resume",
	...
	list_radar_jobs: "Looking through Job Radar",
	get_radar_job: "Opening a Job Radar role",
	get_radar_preferences: "Reading Job Radar preferences",
	update_radar_preferences: "Updating Job Radar preferences",
	shortlist_radar_jobs: "Shortlisting jobs",
	open_job_radar: "Opening Job Radar",
	get_template_source: "Reading your template",
	get_selected_template_kind: "Checking your template",
	patch_template_html: "Updating your template design",
};
