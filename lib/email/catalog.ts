...
export const EMAIL_TEMPLATES: EmailTemplateDef[] = [
	...
	},
	{
		...
		preheader: "Keep writing CVs for $8/month, or paste one job while you still can.",
		headline: "Trial ends in {{{DAYS_LEFT}}} days",
		paragraphs: [
			"Hi {{{NAME}}}. After that, new tailored CVs pause until Pro.",
			"If you haven't pasted a job yet, do that first. If you already have files, Pro is $8 a month.",
		],
		ctaLabel: "Customize your CV",
		preference: "promotional",
	},
	{
		...
		preheader: "Pro is $8/month. Your profile stays either way.",
		headline: "Tomorrow the trial stops writing CVs",
		paragraphs: [
			"Hi {{{NAME}}}. After tomorrow we won't write new tailored files on the trial.",
			"Pro is $8 a month if you have more postings. Your profile stays in the account either way.",
		],
		ctaLabel: "Get Pro",
		preference: "promotional",
	},
	{
		...
		preheader: "Keep the persona. Pro is $8/month.",
		headline: "Trial's over. Your profile is still here.",
		paragraphs: [
			"Hi {{{NAME}}}. We stopped writing new CVs on the free trial.",
			"Your career profile and past files are still in the account. Pro is $8 a month when you want the next posting tailored.",
		],
		ctaLabel: "Get Pro",
		preference: "promotional",
	},
	...
	},
	{
		...
		paragraphs: [
			...
			"Pro is $8 a month if you have more postings to send. Otherwise wait for the reset.",
		],
		ctaLabel: "Get Pro",
		preference: "important",
	},
