...
export const MessageContent = ({
  ...
  <div
    className={cn(
      ...
      "group-[.is-user]:rounded-3xl group-[.is-user]:bg-secondary group-[.is-user]:px-4 group-[.is-user]:py-2.5 group-[.is-user]:text-foreground",
...
const streamdownPlugins = {
  ...
  math,
  mermaid,
} as MessageResponseProps["plugins"];
