	...
	return (
		...
		>
			...
			<section className="space-y-3">
				...
				<p>
					Pro is $5 a month after a 7-day trial. Lifetime is $150
					once. Payments are processed by Dodo Payments. Usage limits
					apply so the product stays usable. Refunds are handled case
					by case. Email{" "}
