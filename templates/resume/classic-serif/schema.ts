...
export const documentSchema = z.object({
	...
	projects: z
		.array(
			z.object({
				...
				stack: z
					...
					.optional()
					.describe(
						"Comma-separated stack; this layout joins stack + bullets onto one line",
					),
		...
		.describe("Optional. Compact one-liners. Omit or [] if none."),
	education: z
		.array(
			z.object({
...
export type ClassicSerifDocument = z.infer<typeof documentSchema>;
