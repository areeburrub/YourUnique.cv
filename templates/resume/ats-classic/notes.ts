export const notes = `# ATS Classic template notes
...
This page is built for applicant tracking systems: one column, no sidebar, no icons, no tables.

## Layout (how this page reads)

- Left-aligned name, optional headline, then one contact line (location, phone, email, website, GitHub, LinkedIn)
- ALL CAPS section titles with a single rule
- Experience: company then title / dates; bullets as plain sentences
...
- \`headline\`: a real target title from the profile or JD. Omit if none.
