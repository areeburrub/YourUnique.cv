...
export const documentSchema = z.object({
	...
	headline: z
		...
		.optional()
		.describe(
			'Short target title under the name in the sidebar, e.g. "Senior Product Engineer". Omit if none.',
		),
	...
	location: z
		.string()
		.min(1)
		.describe("Shown in the sidebar. City or Remote."),
	...
	skills: z
		...
		.min(1)
		.describe("Renders in the left sidebar."),
	projects: z
		.array(
			z.object({
				name: z.string().min(1),
...
export type SlateSidebarDocument = z.infer<typeof documentSchema>;
