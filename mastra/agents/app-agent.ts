...
- resume-agent only handles resume generation/editing/PDF work — the resume's content. It reads the saved profile and may call profile-edit-agent itself when facts are missing.
