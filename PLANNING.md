...
| PDF | **Typst** (CLI in Trigger.dev worker) | Not a hosted service; binary on worker. LaTeX optional later |
...
- **No Inngest** — Trigger.dev wins on price (Free → Hobby $10 vs Inngest Pro $99) and on running Typst binaries outside Vercel serverless limits.
